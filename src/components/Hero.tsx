      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="flex justify-center space-x-4 animate-fade-in-up animation-delay-300">
            <button className="group relative px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-semibold overflow-hidden transition-all hover:shadow-[0_0_40px_8px_rgba(56,189,248,0.3)]">
